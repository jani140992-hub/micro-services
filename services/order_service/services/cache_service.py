"""Distributed Cache Service for Order Management Service."""
...
class CustomerOrderCacheService:
    ...
    def _format_key(self, entity_id: str) -> str:
        return f"cloudmart:order_service:entity:{entity_id}"
    ...
    async def set(self, entity: CustomerOrderAggregate) -> None:
