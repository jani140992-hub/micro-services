"""Search Query Criteria and Filter DTOs for Order Management Service."""

from datetime import datetime
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field

class CustomerOrderSortOption(BaseModel):
    sort_field: str = Field(default="created_at")
    is_descending: bool = Field(default=True)

class CustomerOrderTimeWindowFilter(BaseModel):
    start_time: Optional[datetime] = None
    end_time: Optional[datetime] = None
    is_inclusive: bool = True

class CustomerOrderSearchQuery(BaseModel):
    """Comprehensive multi-parameter query for CustomerOrder."""
    ...
    time_window: Optional[CustomerOrderTimeWindowFilter] = None
    sort_options: List[CustomerOrderSortOption] = Field(default_factory=list)
