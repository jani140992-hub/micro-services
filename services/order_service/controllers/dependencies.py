"""Dependency Injection Providers for Order Management Service Controllers."""
...
from services.order_service.domain.rules import CustomerOrderRuleEngine
from services.order_service.services.saga_participant import CustomerOrderSagaParticipant
...
_rules = CustomerOrderRuleEngine()
_saga = CustomerOrderSagaParticipant(service=_service)
_jwt = JWTManager()

def get_order_service_service() -> CustomerOrderService:
    return _service

def get_order_service_repository() -> CustomerOrderRepository:
    return _repo

def get_order_service_cache() -> CustomerOrderCacheService:
    return _cache

def get_order_service_rule_engine() -> CustomerOrderRuleEngine:
    return _rules

def get_order_service_saga_participant() -> CustomerOrderSagaParticipant:
    return _saga
