"""Distributed Cache Service for Notification & Messaging Service."""
...
class NotificationMessageCacheService:
    ...
    def _format_key(self, entity_id: str) -> str:
        return f"cloudmart:notification_service:entity:{entity_id}"
    ...
    async def set(self, entity: NotificationMessageAggregate) -> None:
