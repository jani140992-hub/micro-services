"""Domain and Persistence Entity Mappers for Notification & Messaging Service."""
...
from services.notification_service.repositories.models import NotificationMessageORM, DeliveryAttemptRecordORM, TemplateVariableORM
from services.notification_service.dto.responses import NotificationMessageDetailResponse, NotificationMessageSummaryResponse

logger = logging.getLogger("notification_service.mappers")

class NotificationMessageDataMapper:
    """Bi-directional mapping between domain aggregates and database models."""
    @staticmethod
    def to_orm(aggregate: NotificationMessageAggregate) -> NotificationMessageORM:
        orm = NotificationMessageORM(
            id=aggregate.id,
    ...
    @staticmethod
    def to_domain(orm: NotificationMessageORM) -> NotificationMessageAggregate:
        return NotificationMessageAggregate(
            id=orm.id,
...
class ContextProjectionMapper01:
    ...
    def transform(self, aggregate: NotificationMessageAggregate) -> Dict[str, Any]:
        return {
