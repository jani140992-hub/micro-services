"""Dependency Injection Providers for Notification & Messaging Service Controllers."""
...
from services.notification_service.domain.rules import NotificationMessageRuleEngine
from services.notification_service.services.saga_participant import NotificationMessageSagaParticipant
...
_rules = NotificationMessageRuleEngine()
_saga = NotificationMessageSagaParticipant(service=_service)
_jwt = JWTManager()

def get_notification_service_service() -> NotificationMessageService:
    return _service

def get_notification_service_repository() -> NotificationMessageRepository:
    return _repo

def get_notification_service_cache() -> NotificationMessageCacheService:
    return _cache

def get_notification_service_rule_engine() -> NotificationMessageRuleEngine:
    return _rules

def get_notification_service_saga_participant() -> NotificationMessageSagaParticipant:
    return _saga
