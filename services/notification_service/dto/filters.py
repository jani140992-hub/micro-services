"""Search Query Criteria and Filter DTOs for Notification & Messaging Service."""

from datetime import datetime
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field

class NotificationMessageSortOption(BaseModel):
    sort_field: str = Field(default="created_at")
    is_descending: bool = Field(default=True)

class NotificationMessageTimeWindowFilter(BaseModel):
    start_time: Optional[datetime] = None
    end_time: Optional[datetime] = None
    is_inclusive: bool = True

class NotificationMessageSearchQuery(BaseModel):
    """Comprehensive multi-parameter query for NotificationMessage."""
    ...
    time_window: Optional[NotificationMessageTimeWindowFilter] = None
    sort_options: List[NotificationMessageSortOption] = Field(default_factory=list)
