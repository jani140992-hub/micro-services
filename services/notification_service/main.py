"""FastAPI Application Main Entrypoint for Notification & Messaging Service."""

import uvicorn
from contextlib import asynccontextmanager
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
from services.notification_service.controllers.routes import router
from services.notification_service.config.settings import settings
...
app = FastAPI(
    ...
    description="Multi-channel notification dispatcher supporting Email, SMS, Webhook, and WebSocket with Jinja2 templates and DLQ retry.",
    version="1.0.0",
    lifespan=lifespan
)
...
async def readiness_check():
    return {"status": "ready", "service": "notification_service"}
