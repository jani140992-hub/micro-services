"""Configuration Settings for Notification & Messaging Service."""
...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql+asyncpg://cloudmart_user:cloudmart_password@localhost:5432/notification_db"
