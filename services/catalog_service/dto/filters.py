"""Search Query Criteria and Filter DTOs for Product Catalog Service."""

from datetime import datetime
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field

class ProductItemSortOption(BaseModel):
    sort_field: str = Field(default="created_at")
    is_descending: bool = Field(default=True)

class ProductItemTimeWindowFilter(BaseModel):
    start_time: Optional[datetime] = None
    end_time: Optional[datetime] = None
    is_inclusive: bool = True

class ProductItemSearchQuery(BaseModel):
    """Comprehensive multi-parameter query for ProductItem."""
    ...
    time_window: Optional[ProductItemTimeWindowFilter] = None
    sort_options: List[ProductItemSortOption] = Field(default_factory=list)
