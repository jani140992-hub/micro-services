"""Domain and Persistence Entity Mappers for Product Catalog Service."""

import logging
from typing import Any, Dict, List, Optional
from services.catalog_service.domain.models import ProductItemAggregate, ProductVariant, ProductAttribute
from services.catalog_service.repositories.models import ProductItemORM, ProductVariantORM, ProductAttributeORM
from services.catalog_service.dto.responses import ProductItemDetailResponse, ProductItemSummaryResponse

logger = logging.getLogger("catalog_service.mappers")

class ProductItemDataMapper:
    """Bi-directional mapping between domain aggregates and database models."""
    @staticmethod
    def to_orm(aggregate: ProductItemAggregate) -> ProductItemORM:
        orm = ProductItemORM(
            id=aggregate.id,
    ...
    @staticmethod
    def to_domain(orm: ProductItemORM) -> ProductItemAggregate:
...
class ContextProjectionMapper01:
    ...
    def transform(self, aggregate: ProductItemAggregate) -> Dict[str, Any]:
        return {
