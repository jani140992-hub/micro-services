"""Dependency Injection Providers for Product Catalog Service Controllers."""
...
from services.catalog_service.domain.rules import ProductItemRuleEngine
from services.catalog_service.services.saga_participant import ProductItemSagaParticipant
...
_rules = ProductItemRuleEngine()
_saga = ProductItemSagaParticipant(service=_service)
_jwt = JWTManager()

def get_catalog_service_service() -> ProductItemService:
    return _service

def get_catalog_service_repository() -> ProductItemRepository:
    return _repo

def get_catalog_service_cache() -> ProductItemCacheService:
    return _cache

def get_catalog_service_rule_engine() -> ProductItemRuleEngine:
    return _rules

def get_catalog_service_saga_participant() -> ProductItemSagaParticipant:
    return _saga
