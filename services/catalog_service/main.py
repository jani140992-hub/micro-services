"""FastAPI Application Main Entrypoint for Product Catalog Service."""

import uvicorn
from contextlib import asynccontextmanager
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
from services.catalog_service.controllers.routes import router
from services.catalog_service.config.settings import settings
...
app = FastAPI(
    ...
    description="Manages product catalog taxonomy, multi-variant items, pricing rules, search indexing, and attribute filters.",
    version="1.0.0",
    lifespan=lifespan
)
...
async def readiness_check():
    return {"status": "ready", "service": "catalog_service"}
