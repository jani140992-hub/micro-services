"""Search Query Criteria and Filter DTOs for Analytics & BI Service."""

from datetime import datetime
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field

class StreamMetricRecordSortOption(BaseModel):
    sort_field: str = Field(default="created_at")
    is_descending: bool = Field(default=True)

class StreamMetricRecordTimeWindowFilter(BaseModel):
    start_time: Optional[datetime] = None
    end_time: Optional[datetime] = None
    is_inclusive: bool = True

class StreamMetricRecordSearchQuery(BaseModel):
    """Comprehensive multi-parameter query for StreamMetricRecord."""
    ...
    time_window: Optional[StreamMetricRecordTimeWindowFilter] = None
    sort_options: List[StreamMetricRecordSortOption] = Field(default_factory=list)
