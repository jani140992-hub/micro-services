"""Request DTOs for Analytics & BI Service."""

from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field, field_validator

class CreateStreamMetricRecordRequest(BaseModel):
...
class BatchStreamMetricRecordActionRequest(BaseModel):
