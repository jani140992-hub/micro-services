"""Domain and Persistence Entity Mappers for Analytics & BI Service."""
...
from services.analytics_service.repositories.models import StreamMetricRecordORM, TimeSeriesDataPointORM, AggregationDimensionORM
from services.analytics_service.dto.responses import StreamMetricRecordDetailResponse, StreamMetricRecordSummaryResponse

logger = logging.getLogger("analytics_service.mappers")

class StreamMetricRecordDataMapper:
    """Bi-directional mapping between domain aggregates and database models."""
    @staticmethod
    def to_orm(aggregate: StreamMetricRecordAggregate) -> StreamMetricRecordORM:
        orm = StreamMetricRecordORM(
            id=aggregate.id,
    ...
    @staticmethod
    def to_domain(orm: StreamMetricRecordORM) -> StreamMetricRecordAggregate:
        return StreamMetricRecordAggregate(
            id=orm.id,
...
class ContextProjectionMapper01:
    ...
    def transform(self, aggregate: StreamMetricRecordAggregate) -> Dict[str, Any]:
        return {
