"""Distributed Cache Service for Analytics & BI Service."""
...
class StreamMetricRecordCacheService:
    ...
    def _format_key(self, entity_id: str) -> str:
        return f"cloudmart:analytics_service:entity:{entity_id}"
    ...
    async def set(self, entity: StreamMetricRecordAggregate) -> None:
