"""Dependency Injection Providers for API Gateway Service Controllers."""
...
from services.api_gateway.domain.rules import GatewayRouteRuleEngine
from services.api_gateway.services.saga_participant import GatewayRouteSagaParticipant
...
_rules = GatewayRouteRuleEngine()
_saga = GatewayRouteSagaParticipant(service=_service)
_jwt = JWTManager()

def get_api_gateway_service() -> GatewayRouteService:
    return _service

def get_api_gateway_repository() -> GatewayRouteRepository:
    return _repo

def get_api_gateway_cache() -> GatewayRouteCacheService:
    return _cache

def get_api_gateway_rule_engine() -> GatewayRouteRuleEngine:
    return _rules

def get_api_gateway_saga_participant() -> GatewayRouteSagaParticipant:
    return _saga
