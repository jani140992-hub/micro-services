"""Search Query Criteria and Filter DTOs for API Gateway Service."""

from datetime import datetime
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field

class GatewayRouteSortOption(BaseModel):
    sort_field: str = Field(default="created_at")
    is_descending: bool = Field(default=True)

class GatewayRouteTimeWindowFilter(BaseModel):
    start_time: Optional[datetime] = None
    end_time: Optional[datetime] = None
    is_inclusive: bool = True

class GatewayRouteSearchQuery(BaseModel):
    """Comprehensive multi-parameter query for GatewayRoute."""
    ...
    time_window: Optional[GatewayRouteTimeWindowFilter] = None
    sort_options: List[GatewayRouteSortOption] = Field(default_factory=list)
