"""Domain and Persistence Entity Mappers for API Gateway Service."""

import logging
from typing import Any, Dict, List, Optional
from services.api_gateway.domain.models import GatewayRouteAggregate, RoutePredicate, RouteFilter
from services.api_gateway.repositories.models import GatewayRouteORM, RoutePredicateORM, RouteFilterORM
from services.api_gateway.dto.responses import GatewayRouteDetailResponse, GatewayRouteSummaryResponse

logger = logging.getLogger("api_gateway.mappers")

class GatewayRouteDataMapper:
    """Bi-directional mapping between domain aggregates and database models."""
    @staticmethod
    def to_orm(aggregate: GatewayRouteAggregate) -> GatewayRouteORM:
        orm = GatewayRouteORM(
            id=aggregate.id,
    ...
    @staticmethod
    def to_domain(orm: GatewayRouteORM) -> GatewayRouteAggregate:
...
class ContextProjectionMapper01:
    ...
    def transform(self, aggregate: GatewayRouteAggregate) -> Dict[str, Any]:
        return {
