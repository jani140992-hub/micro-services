"""Distributed Cache Service for API Gateway Service."""
...
class GatewayRouteCacheService:
    ...
    def _format_key(self, entity_id: str) -> str:
        return f"cloudmart:api_gateway:entity:{entity_id}"
    ...
    async def set(self, entity: GatewayRouteAggregate) -> None:
