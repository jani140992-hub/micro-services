"""FastAPI Application Main Entrypoint for Shipping & Logistics Service."""

import uvicorn
from contextlib import asynccontextmanager
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
from services.shipping_service.controllers.routes import router
from services.shipping_service.config.settings import settings
...
app = FastAPI(
    ...
    description="Manages carrier integrations (FedEx, UPS, DHL), tracking checkpoints, dispatch routing, and shipping labels.",
    version="1.0.0",
    lifespan=lifespan
)
...
async def readiness_check():
    return {"status": "ready", "service": "shipping_service"}
