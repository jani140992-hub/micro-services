"""Distributed Cache Service for Shipping & Logistics Service."""
...
class ShipmentConsignmentCacheService:
    ...
    def _format_key(self, entity_id: str) -> str:
        return f"cloudmart:shipping_service:entity:{entity_id}"
    ...
    async def set(self, entity: ShipmentConsignmentAggregate) -> None:
