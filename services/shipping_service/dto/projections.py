"""Read-Model Projections and Specialized Views for Shipping & Logistics Service."""

from datetime import datetime
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field

class ShipmentConsignmentAuditTrailView(BaseModel):
    entry_id: str
    actor_username: str
    action_type: str
...
class ShipmentConsignmentCustomProjectionView01(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView01":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView02(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView02":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView03(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView03":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView04(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView04":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView05(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView05":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView06(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView06":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView07(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView07":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView08(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView08":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView09(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView09":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView10(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView10":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView11(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView11":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView12(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView12":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView13(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView13":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView14(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView14":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView15(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView15":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView16(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView16":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView17(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView17":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView18(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView18":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView19(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView19":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView20(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView20":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView21(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView21":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView22(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView22":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView23(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView23":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView24(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView24":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView25(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView25":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView26(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView26":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView27(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView27":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView28(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView28":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView29(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView29":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView30(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView30":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView31(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView31":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView32(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView32":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView33(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView33":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView34(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView34":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView35(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView35":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView36(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView36":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView37(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView37":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView38(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView38":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView39(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView39":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView40(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView40":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView41(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView41":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView42(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView42":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView43(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView43":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
...
class ShipmentConsignmentCustomProjectionView44(BaseModel):
    ...
    @classmethod
    def from_aggregate(cls, agg: Any) -> "ShipmentConsignmentCustomProjectionView44":
        return cls(
            aggregate_id=agg.id,
            name=agg.name,
            code=agg.code,
