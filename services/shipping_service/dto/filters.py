"""Search Query Criteria and Filter DTOs for Shipping & Logistics Service."""

from datetime import datetime
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field

class ShipmentConsignmentSortOption(BaseModel):
    sort_field: str = Field(default="created_at")
    is_descending: bool = Field(default=True)

class ShipmentConsignmentTimeWindowFilter(BaseModel):
    start_time: Optional[datetime] = None
    end_time: Optional[datetime] = None
    is_inclusive: bool = True

class ShipmentConsignmentSearchQuery(BaseModel):
    """Comprehensive multi-parameter query for ShipmentConsignment."""
    ...
    time_window: Optional[ShipmentConsignmentTimeWindowFilter] = None
    sort_options: List[ShipmentConsignmentSortOption] = Field(default_factory=list)
