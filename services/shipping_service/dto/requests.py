"""Request DTOs for Shipping & Logistics Service."""

from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field, field_validator

class CreateShipmentConsignmentRequest(BaseModel):
...
class BatchShipmentConsignmentActionRequest(BaseModel):
