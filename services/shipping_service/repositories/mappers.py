"""Domain and Persistence Entity Mappers for Shipping & Logistics Service."""
...
from services.shipping_service.repositories.models import ShipmentConsignmentORM, TrackingCheckpointORM, ShippingManifestORM
from services.shipping_service.dto.responses import ShipmentConsignmentDetailResponse, ShipmentConsignmentSummaryResponse

logger = logging.getLogger("shipping_service.mappers")

class ShipmentConsignmentDataMapper:
    """Bi-directional mapping between domain aggregates and database models."""
    @staticmethod
    def to_orm(aggregate: ShipmentConsignmentAggregate) -> ShipmentConsignmentORM:
        orm = ShipmentConsignmentORM(
            id=aggregate.id,
    ...
    @staticmethod
    def to_domain(orm: ShipmentConsignmentORM) -> ShipmentConsignmentAggregate:
        return ShipmentConsignmentAggregate(
            id=orm.id,
...
class ContextProjectionMapper01:
    ...
    def transform(self, aggregate: ShipmentConsignmentAggregate) -> Dict[str, Any]:
        return {
