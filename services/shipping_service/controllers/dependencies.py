"""Dependency Injection Providers for Shipping & Logistics Service Controllers."""
...
from services.shipping_service.domain.rules import ShipmentConsignmentRuleEngine
from services.shipping_service.services.saga_participant import ShipmentConsignmentSagaParticipant
...
_rules = ShipmentConsignmentRuleEngine()
_saga = ShipmentConsignmentSagaParticipant(service=_service)
_jwt = JWTManager()

def get_shipping_service_service() -> ShipmentConsignmentService:
    return _service

def get_shipping_service_repository() -> ShipmentConsignmentRepository:
    return _repo

def get_shipping_service_cache() -> ShipmentConsignmentCacheService:
    return _cache

def get_shipping_service_rule_engine() -> ShipmentConsignmentRuleEngine:
    return _rules

def get_shipping_service_saga_participant() -> ShipmentConsignmentSagaParticipant:
    return _saga
