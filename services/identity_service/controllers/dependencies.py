"""Dependency Injection Providers for Identity & Authentication Service Controllers."""
...
from services.identity_service.domain.rules import UserCredentialRuleEngine
from services.identity_service.services.saga_participant import UserCredentialSagaParticipant
...
_rules = UserCredentialRuleEngine()
_saga = UserCredentialSagaParticipant(service=_service)
_jwt = JWTManager()

def get_identity_service_service() -> UserCredentialService:
    return _service

def get_identity_service_repository() -> UserCredentialRepository:
    return _repo

def get_identity_service_cache() -> UserCredentialCacheService:
    return _cache

def get_identity_service_rule_engine() -> UserCredentialRuleEngine:
    return _rules

def get_identity_service_saga_participant() -> UserCredentialSagaParticipant:
    return _saga
