"""Request DTOs for Identity & Authentication Service."""
...
class UpdateUserCredentialRequest(BaseModel):
    name: Optional[str] = Field(None, min_length=2, max_length=150)
    description: Optional[str] = Field(None, max_length=2000)
    category: Optional[str] = Field(None, max_length=50)
    attributes: Optional[Dict[str, Any]] = None

class ChangeUserCredentialStatusRequest(BaseModel):
...
class QueryUserCredentialRequest(BaseModel):
...
class BatchUserCredentialActionRequest(BaseModel):
