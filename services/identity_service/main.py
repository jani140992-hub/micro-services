"""FastAPI Application Main Entrypoint for Identity & Authentication Service."""

import uvicorn
from contextlib import asynccontextmanager
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
from services.identity_service.controllers.routes import router
from services.identity_service.config.settings import settings
...
app = FastAPI(
    ...
    description="Handles user credentials, password hashing, OAuth2 token pairs, session management, and role-based access control.",
    version="1.0.0",
    lifespan=lifespan
)
...
async def readiness_check():
    return {"status": "ready", "service": "identity_service"}
