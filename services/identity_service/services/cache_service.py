"""Distributed Cache Service for Identity & Authentication Service."""
...
class UserCredentialCacheService:
    ...
    def _format_key(self, entity_id: str) -> str:
        return f"cloudmart:identity_service:entity:{entity_id}"
    ...
    async def set(self, entity: UserCredentialAggregate) -> None:
