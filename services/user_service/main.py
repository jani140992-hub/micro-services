"""FastAPI Application Main Entrypoint for User Profile Service."""

import uvicorn
from contextlib import asynccontextmanager
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
from services.user_service.controllers.routes import router
from services.user_service.config.settings import settings
...
app = FastAPI(
    ...
    description="Maintains customer profiles, address books, preferences, KYC compliance, and GDPR data export and deletion.",
    version="1.0.0",
    lifespan=lifespan
)
...
async def readiness_check():
    return {"status": "ready", "service": "user_service"}
