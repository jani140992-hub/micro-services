"""Search Query Criteria and Filter DTOs for User Profile Service."""

from datetime import datetime
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field

class UserProfileSortOption(BaseModel):
    sort_field: str = Field(default="created_at")
    is_descending: bool = Field(default=True)

class UserProfileTimeWindowFilter(BaseModel):
    start_time: Optional[datetime] = None
    end_time: Optional[datetime] = None
    is_inclusive: bool = True

class UserProfileSearchQuery(BaseModel):
    """Comprehensive multi-parameter query for UserProfile."""
    ...
    time_window: Optional[UserProfileTimeWindowFilter] = None
    sort_options: List[UserProfileSortOption] = Field(default_factory=list)
