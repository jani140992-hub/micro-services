"""Response DTOs for User Profile Service."""
...
class UserProfileDetailResponse(BaseModel):
    ...
    is_active: bool
    is_deleted: bool
    sub_items_1: List[CustomerAddressResponse]
    sub_items_2: List[UserPreferenceResponse]
...
class UserProfilePageResponse(BaseModel):
    items: List[UserProfileSummaryResponse]
