"""Dependency Injection Providers for User Profile Service Controllers."""
...
from services.user_service.domain.rules import UserProfileRuleEngine
from services.user_service.services.saga_participant import UserProfileSagaParticipant
...
_rules = UserProfileRuleEngine()
_saga = UserProfileSagaParticipant(service=_service)
_jwt = JWTManager()

def get_user_service_service() -> UserProfileService:
    return _service

def get_user_service_repository() -> UserProfileRepository:
    return _repo

def get_user_service_cache() -> UserProfileCacheService:
    return _cache

def get_user_service_rule_engine() -> UserProfileRuleEngine:
    return _rules

def get_user_service_saga_participant() -> UserProfileSagaParticipant:
    return _saga
