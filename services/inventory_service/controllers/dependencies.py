"""Dependency Injection Providers for Inventory Management Service Controllers."""
...
from services.inventory_service.domain.rules import StockItemRuleEngine
from services.inventory_service.services.saga_participant import StockItemSagaParticipant
...
_rules = StockItemRuleEngine()
_saga = StockItemSagaParticipant(service=_service)
_jwt = JWTManager()

def get_inventory_service_service() -> StockItemService:
    return _service

def get_inventory_service_repository() -> StockItemRepository:
    return _repo

def get_inventory_service_cache() -> StockItemCacheService:
    return _cache

def get_inventory_service_rule_engine() -> StockItemRuleEngine:
    return _rules

def get_inventory_service_saga_participant() -> StockItemSagaParticipant:
    return _saga
