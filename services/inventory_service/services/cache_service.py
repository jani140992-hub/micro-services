"""Distributed Cache Service for Inventory Management Service."""
...
class StockItemCacheService:
    ...
    def _format_key(self, entity_id: str) -> str:
        return f"cloudmart:inventory_service:entity:{entity_id}"
    ...
    async def set(self, entity: StockItemAggregate) -> None:
