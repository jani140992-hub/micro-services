"""Search Query Criteria and Filter DTOs for Inventory Management Service."""

from datetime import datetime
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field

class StockItemSortOption(BaseModel):
    sort_field: str = Field(default="created_at")
    is_descending: bool = Field(default=True)

class StockItemTimeWindowFilter(BaseModel):
    start_time: Optional[datetime] = None
    end_time: Optional[datetime] = None
    is_inclusive: bool = True

class StockItemSearchQuery(BaseModel):
    """Comprehensive multi-parameter query for StockItem."""
    ...
    time_window: Optional[StockItemTimeWindowFilter] = None
    sort_options: List[StockItemSortOption] = Field(default_factory=list)
