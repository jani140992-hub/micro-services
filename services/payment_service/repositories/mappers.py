"""Domain and Persistence Entity Mappers for Payment & Billing Service."""

import logging
from typing import Any, Dict, List, Optional
from services.payment_service.domain.models import PaymentTransactionAggregate, LedgerEntry, RefundItem
from services.payment_service.repositories.models import PaymentTransactionORM, LedgerEntryORM, RefundItemORM
from services.payment_service.dto.responses import PaymentTransactionDetailResponse, PaymentTransactionSummaryResponse

logger = logging.getLogger("payment_service.mappers")

class PaymentTransactionDataMapper:
    """Bi-directional mapping between domain aggregates and database models."""
    @staticmethod
    def to_orm(aggregate: PaymentTransactionAggregate) -> PaymentTransactionORM:
    ...
    @staticmethod
    def to_domain(orm: PaymentTransactionORM) -> PaymentTransactionAggregate:
...
class ContextProjectionMapper01:
    ...
    def transform(self, aggregate: PaymentTransactionAggregate) -> Dict[str, Any]:
        return {
