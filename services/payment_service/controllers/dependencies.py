"""Dependency Injection Providers for Payment & Billing Service Controllers."""
...
from services.payment_service.domain.rules import PaymentTransactionRuleEngine
from services.payment_service.services.saga_participant import PaymentTransactionSagaParticipant
...
_rules = PaymentTransactionRuleEngine()
_saga = PaymentTransactionSagaParticipant(service=_service)
_jwt = JWTManager()

def get_payment_service_service() -> PaymentTransactionService:
    return _service

def get_payment_service_repository() -> PaymentTransactionRepository:
    return _repo

def get_payment_service_cache() -> PaymentTransactionCacheService:
    return _cache

def get_payment_service_rule_engine() -> PaymentTransactionRuleEngine:
    return _rules

def get_payment_service_saga_participant() -> PaymentTransactionSagaParticipant:
    return _saga
