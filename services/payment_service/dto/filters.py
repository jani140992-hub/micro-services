"""Search Query Criteria and Filter DTOs for Payment & Billing Service."""

from datetime import datetime
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, Field

class PaymentTransactionSortOption(BaseModel):
    sort_field: str = Field(default="created_at")
    is_descending: bool = Field(default=True)

class PaymentTransactionTimeWindowFilter(BaseModel):
    start_time: Optional[datetime] = None
    end_time: Optional[datetime] = None
    is_inclusive: bool = True

class PaymentTransactionSearchQuery(BaseModel):
    """Comprehensive multi-parameter query for PaymentTransaction."""
    ...
    time_window: Optional[PaymentTransactionTimeWindowFilter] = None
    sort_options: List[PaymentTransactionSortOption] = Field(default_factory=list)
