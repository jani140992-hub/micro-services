"""Distributed Cache Service for Payment & Billing Service."""
...
class PaymentTransactionCacheService:
    ...
    def _format_key(self, entity_id: str) -> str:
        return f"cloudmart:payment_service:entity:{entity_id}"
    ...
    async def set(self, entity: PaymentTransactionAggregate) -> None:
