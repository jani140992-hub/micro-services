# ADR 006: Asymmetric JWT Bearer Tokens with Fine-Grained RBAC

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
Edge API Gateway terminates public requests and verifies client identity. Microservices validate stateless JWT tokens carrying cryptographically verified role and permission claims.
