# ADR 009: CQRS with Read-Model Redis Caching

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
High-frequency catalog queries saturate PostgreSQL relational instances. We decouple read and write paths using Redis caching for high read-to-write ratio microservices.
