# ADR 010: Idempotent Consumer Design for Kafka Events

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
Kafka provides at-least-once delivery guarantees. Network retries can result in duplicate event consumption. We enforce an idempotency key store across all consumers.
