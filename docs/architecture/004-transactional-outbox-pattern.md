# ADR 004: Transactional Outbox Pattern for At-Least-Once Delivery

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
Dual-write bugs (saving to DB while broker is down) lead to state inconsistencies. We adopt the Transactional Outbox Pattern where domain events are committed atomically with business entities into an outbox table.
