# ADR 014: Zero-Trust Inter-Service Mesh Security

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
Internal network perimeters are insufficient. We enforce mutual TLS (mTLS) with SPIFFE/SPIRE identities and Kubernetes NetworkPolicies between microservices.
