# ADR 005: Adoption of CloudEvents v1.0 Standard

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
Heterogeneous microservices need uniform event serialization. We standardize on the CNCF CloudEvents v1.0 specification for all asynchronous message payloads.
