# ADR 015: Right to be Forgotten & Cryptographic Erasure

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
Privacy regulations require verifiable deletion of customer PII across distributed databases. We implement cryptographic shredding where encryption keys are discarded upon erasure requests.
