# ADR 016: Active-Passive Multi-Region Disaster Recovery

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
To guarantee 99.99% availability, databases are replicated via cross-region read replicas with automated Route 53 DNS failover.
