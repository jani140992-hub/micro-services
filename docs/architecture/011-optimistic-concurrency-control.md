# ADR 011: Optimistic Concurrency Control with Entity Versioning

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
Simultaneous stock reservations or order modifications can overwrite data. Every domain aggregate maintains an integer version attribute that enforces optimistic concurrency locking.
