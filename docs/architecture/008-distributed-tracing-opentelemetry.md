# ADR 008: OpenTelemetry Tracing with Correlation IDs

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
Tracing asynchronous requests across 10 microservices requires end-to-end context propagation. We mandate OpenTelemetry trace context and X-Correlation-ID headers across all HTTP and Kafka boundaries.
