# ADR 007: Defense-in-Depth Distributed Resilience

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
Network partitions and downstream failures cascade quickly. We mandate Circuit Breakers, Leaky Bucket Rate Limiters, Bulkheads, and Jittered Exponential Backoff retries on all inter-service communication.
