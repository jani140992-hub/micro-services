# ADR 013: Zero-Downtime Rolling and Canary Deployments

## Status
**Accepted** (Architecture Review Board Consensus, August 2026)

## Context & Problem Statement
Production releases must not drop active customer sessions. Kubernetes Deployments are configured with maxSurge: 1 and maxUnavailable: 0 coupled with Istio traffic splitting.
